...
pdf(file.path(outputRaw, "cat_proj_plot.pdf")) 
plot(cat_proj_plot)
dev.off()
...
pdf(file.path(outputRaw, "withsomeone_plot.pdf")) 
...
pdf(file.path(outputRaw, "admin_act_plot.pdf")) 
plot(admin_act_plot)
dev.off()
...
pdf(file.path(outputRaw, "planned_act_plot.pdf")) 
...
pdf(file.path(outputRaw, "imp_act_plot.pdf")) 
plot(imp_act_plot)
dev.off()
...
pdf(file.path(outputRaw, "imp_act_s_plot.pdf")) 
plot(imp_act_s_plot)
dev.off()
...
pdf(file.path(outputRaw, "type_act_plot.pdf")) 
...
save.image("~/GitHub/Agile_Productivity_Radar/DataWork/Task Allocation Check in/Report/Pilot/Code/R Markdown/backend.RData")

rmarkdown::render("~/GitHub/Agile_Productivity_Radar/DataWork/Task Allocation Check in/Report/Pilot/Code/R Markdown/Report.Rmd",
