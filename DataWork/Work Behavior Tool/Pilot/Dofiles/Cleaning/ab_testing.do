...
labvars score1`x'	score2`x'	score3`x'	score4`x'	score5`x'	score6`x' 	///
		...
		"Developing the abilities of team members by providing feedback" 		///
		...
		"Genuinely regards people and forms close associations with them" 		///
		...
		"Stay updated on company policies that may impact their activities" 	///
		"Stay updated on the external market to understand its affects" 		///
		"Capable of identifying the dynamics of the organization" 				///
		"Capable of identifying root causes for a problem" 						///
		"Gather and apply knowledge to solve work-related problems" 			///
		...
		"Willing to consider unconventional ideas and solutions to problems" 	///
		"Adding new dimensions to one's work" 									///
		"Flexible approach to one’s work" 										///
		"Desire to design and implement new programs or processes" 				///
		"Constantly work towards deriving innovative solutions to problems" 	///
		"Open to changes taking place in the organization" 						///
		"Ability to take risks" 												///
		"Impervious to social norms and judgement" 								///
		"Determine objectives, set priorities and follow through one's plans" 	///
		"Holds oneself accountable for high quality" 							///
		"Holds oneself accountable for time-effective results" 					///
		...
		"Trusting of others" 													///
		"Cooperative, accomodating and understanding" 							///
		"Able to include other people in decision making" 						///
		"Comfortable in situations involving uncertainty and risks" 			///
		"Effectively adapt to new situations" 									///
		"Takes initiatives and guides others during challenging times" 			///
		"Open to learning from failure" 										///
...
foreach x in "" "a" "b" {
cap noi labvars score3`x'_env  score7`x'_env  score9`x'_env  score14`x'_env 	///
				score16`x'_env score20`x'_env score22`x'_env score25`x'_env 	///
				score28`x'_env score30`x'_env score32`x'_env score33`x'_env 	///
				score37`x'_env score41`x'_env score50`x'_env    				///
		"Env: Facilitates tasks with team members effectively"  				///
		"Env: Fosters an inclusive workplace" 									///
		"Env: Genuinely regards people and forms close associations with them"	///
		"Env: Desire to be collaborative instead of competitive"				///
		"Env: Stay updated on the external market to understand its affects"	///
		"Env: Emotionally stable, reliable and dependent in times of crisis"	///
		"Env: Deals with ambiguity by being methodical and patient"				///
		"Env: Willing to consider unconventional ideas and solutions"			///
		"Env: Desire to design and implement new programs/processes"			///
		"Env: Open to changes taking place in the organization"					///
		"Env: Impervious to social norms and judgment"							///
		"Env: Determine objectives, set priorities and follow through"			///
...
*DEFINING LABELS ON DEMOGRAPHICS
label define genderlbl 	1 		"Female" 										///
						2 		"Male" 											///
						3 		"Transgender Female" 							///
						4 		"Transgender Male" 								///
						5 		"Non-Conforming/Non-Binary/Gender Variant" 		///
						6 		"Not Listed" 									///
						7 		"Prefer Not to Answer"

label define gradelbl 	1 		"GA-GD" 		2 		"GE-GF" 	3 		"GG" ///
						4 		"GH and Above" 	5 		"Prefer Not to Answer"

label define apptlbl 	1 "Open-Ended" 			2 "Term" 			3 "ETC" 	///
						4 "STC/STT" 			5 "Other/Team Member"

label define agelbl 	1 "Less than 30 years" 	2 "31 to 40 years" 	3 "41 to 50 years" ///
						4 "Above 50 years" 		5 "Prefer Not to Answer"

label define explbl 	1 "Less than 5 years" 	2 "5 to 9 years" 	3 "10 to 19 years" ///
						4 "20 to 29 years" 		5 "More than 30 years" 					///
...
label define regionlbl 		0 "Not Mapped to a Region" 		1 "Africa" 			///
							...
							4 "Latin America and Caribbean" 5 "Middle East and Central Asia" ///
							6 "South Asia" 
...
global list 	score1	score2	score3	score4	score5	score6	score7	score8 	///
				...
				score17 score18 score19 score20 score22 score23 score24 score25 ///
				score26 score27 score28 score29 score30 score31 score32 score33 ///
				score34 score35 score36 score37 score38 score39 score40 score41 ///
				score42 score48 score49 score50 score51 score52 score53 score54 ///
				score55 score56

global lista 	score1a		score2a 	score3a 	score4a 	score5a 	score6a		///
				score7a 	score8a 	score9a 	score10a 	score11a 	score12a 	///
				score13a 	score14a 	score15a 	score16a 	score17a 	score18a 	///
				score19a 	score20a 	score22a 	score23a 	score24a 	score25a 	///
				score26a 	score27a 	score28a 	score29a 	score30a 	score31a 	///
				score32a 	score33a 	score34a 	score35a 	score36a 	score37a 	///
				score38a 	score39a 	score40a 	score41a 	score42a 	score48a 	///
				score49a 	score50a 	score51a 	score52a 	score53a 	score54a 	///
				score55a 	score56a

global listb 	score1b 	score2b 	score3b 	score4b 	score5b 	score6b 	///
				score7b 	score8b 	score9b 	score10b 	score11b 	score12b 	///
				score13b 	score14b 	score15b 	score16b 	score17b 	score18b 	///
				score19b 	score20b 	score22b 	score23b 	score24b 	score25b 	///
				score26b 	score27b 	score28b 	score29b 	score30b 	score31b 	///
				score32b 	score33b 	score34b 	score35b 	score36b 	score37b 	///
				score38b 	score39b 	score40b 	score41b 	score42b 	score48b 	///
				score49b 	score50b 	score51b 	score52b 	score53b 	score54b 	///
				score55b 	score56b
...
global enva score14a_env score16a_env score20a_env score22a_env score25a_env 	///
			score28a_env score30a_env score32a_env score33a_env score37a_env 	///
			score3a_env  score41a_env score50a_env score7a_env  score9a_env		///

global envb score14b_env score16b_env score20b_env score22b_env score25b_env 	///
			score28b_env score30b_env score32b_env score33b_env score37b_env 	///
			score3b_env  score41b_env score50b_env score7b_env 	score9b_env
...
foreach x in "" "a" "b" {
forvalues y=1/56 {
cap noi hist score`y'`x'_env, percent bin(5)
graph save score`y'`x'_env.gph, replace
}
}
*/
...
foreach x in "" "a" "b" {
forvalues y=1/56 {
cap noi egen temp`y'`x'1a_env=count(score`y'`x'_env) if score`y'`x'_env==-2
cap noi egen temp`y'`x'1b_env=count(score`y'`x'_env)
cap noi gen score`y'`x'_1_env=temp`y'`x'1a_env/temp`y'`x'1b_env
cap noi drop temp`y'`x'1a_env temp`y'`x'1b_env
}
}

foreach x in "" "a" "b" {
forvalues y=1/56 {
cap noi egen temp`y'`x'2a_env=count(score`y'`x'_env) if score`y'`x'_env==-1
cap noi egen temp`y'`x'2b_env=count(score`y'`x'_env)
cap noi gen score`y'`x'_2_env=temp`y'`x'2a_env/temp`y'`x'2b_env
cap noi drop temp`y'`x'2a_env temp`y'`x'2b_env
}
}

foreach x in "" "a" "b" {
forvalues y=1/56 {
cap noi egen temp`y'`x'3a_env=count(score`y'`x'_env) if score`y'`x'_env==1
cap noi egen temp`y'`x'3b_env=count(score`y'`x'_env)
cap noi gen score`y'`x'_3_env=temp`y'`x'3a_env/temp`y'`x'3b_env
cap noi drop temp`y'`x'3a_env temp`y'`x'3b_env
}
}

foreach x in "" "a" "b" {
forvalues y=1/56 {
cap noi egen temp`y'`x'4a_env=count(score`y'`x'_env) if score`y'`x'_env==2
cap noi egen temp`y'`x'4b_env=count(score`y'`x'_env)
cap noi gen score`y'`x'_4_env=temp`y'`x'4a_env/temp`y'`x'4b_env
cap noi drop temp`y'`x'4a_env temp`y'`x'4b_env
}
}

forvalues y=1/56 {
foreach x in "" "a" "b" {
cap noi replace score`y'`x'_1_env=score`y'`x'_1_env*100
cap noi replace score`y'`x'_2_env=score`y'`x'_2_env*100
cap noi replace score`y'`x'_3_env=score`y'`x'_3_env*100
cap noi replace score`y'`x'_4_env=score`y'`x'_4_env*100
cap noi tabstat score`y'`x'_1_env score`y'`x'_2_env score`y'`x'_3_env score`y'`x'_4_env, stat(mean)
}
}
